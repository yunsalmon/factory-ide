...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        assets = {'/': ('index.html', 'text/html'), '/app.js': ('app.js', 'text/javascript'), '/i18n.js': ('i18n.js', 'text/javascript'), '/allocation-results.js': ('allocation-results.js', 'text/javascript'), '/operations.js': ('operations.js', 'text/javascript'), '/style.css': ('style.css', 'text/css')}
